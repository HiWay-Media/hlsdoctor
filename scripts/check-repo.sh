...
for f in README.md CLAUDE.md CONTRIBUTING.md LICENSE BACKLOG.md ROADMAP.md CHANGELOG.md deploy/nomad/hlsdoctor.nomad.hcl deploy/streams.example.txt; do [ -f "$f" ] || fail "$f is missing"; done
